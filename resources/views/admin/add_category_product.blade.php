	...
	?>
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" id="formValidation" action="/save-category-product" method="post">
                                    {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea style="resize: none " rows="5" class="form-control" name="category_product_keywords" >
                                    </textarea>
                                </div>
                                <div class="form-group">
